...
import styles from './MPA11ReportsHourly.module.scss';
...
const MPA11ReportsHourly = () => {
  ...
  const { data, loading, error } = useHourlyReportByUrl(`/api/reports/BB93-hourly?date=${dateParam}`);
...
export default MPA11ReportsHourly;
