...
import styles from './K295aK296aK295Page.module.scss';
import { useSocket } from '../../hooks/useSocket';
import { DeviceData } from '../../types/types';
import TableHeader from '../../components/Tableheader/TableHeader';
import Loader from '../../ui/loader/Loader';

const K295aK296aK295Page = () => {
  ...
  useEffect(() => {
    ...
    const handleDeviceData = (data: Record<string, DeviceData>) => {
      const k295ak296ak295Data = data['CC125'];

      console.log(k295ak296ak295Data);

      if (k295ak296ak295Data) {
        setDeviceData(k295ak296ak295Data);
      }
    };
  ...
  return (
    <div className={styles['k301-page']}>
      <TableHeader title='к295а/к296а/к295' />
...
export default K295aK296aK295Page;